...
//Moduleç
#define IP_MODULE_ATTRIB_MODEL_KEY              "model_key"
#define IP_MODULE_ATTRIB_TIMESTAMP              "timestamp"
#define IP_MODULE_ATTRIB_MODULE_PART_NUMBER     "module_part_number"
#define IP_MODULE_ATTRIB_MODULE_DESCRIPTION     "module_description"
#define IP_MODULE_ATTRIB_MODULE_SERIAL_NUMBER   "module_serial_number"
#define IP_MODULE_ATTRIB_MODULE_EEEE_CODE       "module_eeee_code"
#define IP_MODULE_ATTRIB_LOT_CODE               "lot_code"
#define IP_MODULE_ATTRIB_DATE_CODE              "date_code"
#define IP_MODULE_ATTRIB_VENDOR_NAME            "vendor_name"
#define IP_MODULE_ATTRIB_ACTION_FLAG            "action_flag"
#define IP_MODULE_ATTRIB_INFO_CODE             "info_code"


//Rework attributes
#define IP_REWORK_ATTRIB_MODEL_KEY              "model_key"
#define IP_REWORK_ATTRIB_FAILURE_LINE_NAME      "failure_line_name"
#define IP_REWORK_ATTRIB_FAILURE_STATION_TYPE   "failure_station_type"
#define IP_REWORK_ATTRIB_FAILURE_TIMESTAMP      "failure_timestamp"
#define IP_REWORK_ATTRIB_FAILURE_SYMPTOM         "failure_symptom"
#define IP_REWORK_ATTRIB_FAILURE_STATION_ID     "failure_station_id"
#define IP_REWORK_ATTRIB_FAILURE_COMPONENT      "failure_component"
#define IP_REWORK_ATTRIB_REWORK_DIAGNOSIS       "rework_diagnosis"
#define IP_REWORK_ATTRIB_REWORK_FIX             "rework_fix"
#define IP_REWORK_ATTRIB_REWORK_COMMENT          "rework_comment"
...
extern "C" {
    ...
    typedef void* IP_ModuleSpecHandle;
    typedef void* IP_ReworkSpecHandle;
    IP_ModuleSpecHandle IP_moduleSpec_create( void );
    IP_ReworkSpecHandle IP_reworkSpec_create( void );
    bool IP_addModuleAttribute( IP_ModuleSpecHandle inHandle, const char* name, const char* value );
	bool IP_addReWorkAttribute( IP_ReworkSpecHandle inHandle, const char* name, const char* value );
    IP_API_Reply IP_addModuleItem( IP_UUTHandle inHandle, IP_ModuleSpecHandle moduleSpec);
    IP_API_Reply IP_addReworkItem( IP_UUTHandle inHandle, IP_ReworkSpecHandle reworkSpec);
    void IP_moduleSpec_destroy( IP_ModuleSpecHandle pecHandle );
	void IP_reworkSpec_destroy( IP_ReworkSpecHandle specHandle );
	...
	///@param replyToCheck : The IP_REPLY to extract the message ID from
    ...
    ///create a new modulespec pointer
