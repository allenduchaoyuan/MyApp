...
- (BOOL)createFileFolder
{
    ...
    if(![fm createDirectoryAtPath:readPath
  withIntermediateDirectories:YES
    ...
    if(![fm createDirectoryAtPath:savePath
  withIntermediateDirectories:YES
                   attributes:nil
                        error:nil])
    {
    ...
    if(![fm createDirectoryAtPath:backupsPath
  withIntermediateDirectories:YES
                   attributes:nil
                        error:nil])
    {
    ...
    if(![fm createDirectoryAtPath:reportPath
  withIntermediateDirectories:YES
                   attributes:nil
                        error:nil])
    {
    ...
    if(![fm createDirectoryAtPath:documentPath
  withIntermediateDirectories:YES
                   attributes:nil
                        error:nil])
    {
...
- (BOOL)backupsFile:(NSString *)fileName
{
    ...
    if(![fm copyItemAtPath:[readPath
                        stringByAppendingPathComponent:fileName]
                   toPath:[backupsPath stringByAppendingFormat:@"%@/%@",backupsDatePath,fileName]
                 error:nil])
    {
        return FALSE;
    }
...
{
    NSFileManager *fm = [NSFileManager defaultManager];
    if(![fm removeItemAtPath:[readPath
    ...
    if(![fm removeItemAtPath:[[readPath
                              stringByAppendingString:[[fileName componentsSeparatedByString:@"."] firstObject]] stringByAppendingString:@".zip"]
                       error:nil])
    {
        return FALSE;
    }
